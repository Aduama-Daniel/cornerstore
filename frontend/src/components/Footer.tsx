        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-cream/80">
              ...
              <li>
                <Link href="/collections/womens" className="hover:text-cream transition-colors">
                  Women's
                </Link>
              </li>
              <li>
                <Link href="/collections/mens" className="hover:text-cream transition-colors">
                  Men's
                </Link>
              </li>
              <li>
                <Link href="/collections/accessories" className="hover:text-cream transition-colors">
                  Accessories
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-cream/80">
              ...
              <li>
                <Link href="/care" className="hover:text-cream transition-colors">
                  Care Instructions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <form className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2 bg-cream/10 border border-cream/20 text-cream placeholder:text-cream/50 focus:outline-none focus:border-cream transition-colors"
                required
              />
              <button
                type="submit"
                className="w-full px-4 py-2 bg-cream text-contrast font-medium uppercase text-sm tracking-wide hover:bg-cream/90 transition-colors"
              >
                Join
              </button>
            </form>
        ...
        <div className="pt-8 border-t border-cream/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-cream/60">
              © {currentYear} Cornerstore. All rights reserved.
            </p>
